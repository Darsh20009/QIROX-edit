  ...
  return (
    <div className="fixed inset-0 z-[100] bg-background flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center space-y-10">
        ...
        >
          <img 
            src={qiroxLogo} 
            alt="QIROX" 
            className="h-20 md:h-28 w-auto mb-8 dark:invert"
          />
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3">
            <span className="text-[10px] tracking-widest uppercase text-muted-foreground/60">v.26</span>
            <div className="w-1 h-1 rounded-full bg-primary" />
            <span className="text-[10px] tracking-widest uppercase text-muted-foreground/60">2030 Vision</span>
          </div>
        </motion.div>
      </div>
      ...
      <motion.div
        ...
        className="absolute inset-0 bg-background z-[110] pointer-events-none"
      />
    </div>
  );
}
